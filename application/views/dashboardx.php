...
<link href="<?php echo base_url(); ?>assets/web/css/barChart.css" rel='stylesheet' type='text/css' />
...
<script src="<?php echo base_url(); ?>assets/web/js/jquery.easydropdown.js"></script>
												...
												<!--/candile-->
													<div class="candile"> 
															...
															vis.render();
																	...
																	<script type="text/javascript" src="<?php echo base_url(); ?>assets/web/js/protovis-d3.2.js"></script>
																	<script type="text/javascript" src="<?php echo base_url(); ?>assets/web/js/vix.js"></script>
												    ...
												    <div class="chrt-bars">
														<div class="col-md-6 chrt-two">
														 <h3 class="sub-tittle">Bar Chart </h3>
															<div id="chart2"></div>
															<script src="<?php echo base_url(); ?>assets/web/js/fabochart.js"></script>
															<script>
												...
												<div class="col-md-6 chrt-two area">
															<h3 class="sub-tittle">Line Multi Chart</h3>
															 <div style="area">
																...
																<script src="<?php echo base_url(); ?>assets/web/js/Chart.js"></script>
															</div>
															<div class="col-md-6 chrt-three">
																 ...
																 <div class="profile-nav alt">
																	<section class="panel">
																		...
																		<ul class="clock-category">
																			<li>
																				<a href="#" class="active">
																					<img src="<?php echo base_url(); ?>assets/web/images/time.png" alt="">
																					<span>Clock</span>
																				</a>
																			</li>
																			<li>
																				<a href="#">
																					<img src="<?php echo base_url(); ?>assets/web/images/alarm.png" alt="">
																					<span>Alarm</span>
																				</a>
																			</li>
																			<li>
																				<a href="#">
																					<img src="<?php echo base_url(); ?>assets/web/images/watch.png" alt="">
																					<span>Stop watch</span>
																				</a>
																			</li>
																			<li>
																				<a href="#">
																					<img src="<?php echo base_url(); ?>assets/web/images/timer.png" alt="">
																					<span>Timer</span>
																				</a>
																			</li>
																		</ul>
